...
class ViewController: UITableViewController {
    ...
    @objc func promptForAnswer(){
        ...
        let submitAction = UIAlertAction(title: "Submit", style: .default) { [unowned self, ac] (action: UIAlertAction) in let answer = ac.textFields![0]
